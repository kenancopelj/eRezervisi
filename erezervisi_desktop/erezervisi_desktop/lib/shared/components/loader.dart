...
/// that are relevant to the [LoaderIndicator] class:
///
...
class LoaderIndicator extends StatefulWidget {
  ...
  @override
  _LoaderIndicatorState createState() => _LoaderIndicatorState();
}
...
class _LoaderIndicatorState extends State<LoaderIndicator>
  ...
  @override
  void didUpdateWidget(LoaderIndicator oldWidget) {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CustomPaint(
        painter: _LoaderIndicatorPainter(
...
class _LoaderIndicatorPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_LoaderIndicatorPainter oldPainter) {
