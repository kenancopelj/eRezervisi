...
namespace eRezervisi.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241005182023_AddedTapPositionAndAddressToAccUnit")]
    partial class AddedTapPositionAndAddressToAccUnit
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("eRezervisi.Core.Domain.Entities.UserCredentials", "UserCredentials", b1 =>
                        {
                            ...
                            b1.HasData(
                                ...
                                {
                                    UserId = 1L,
                                    LastPasswordChangeAt = new DateTime(2024, 10, 5, 20, 20, 23, 277, DateTimeKind.Local).AddTicks(2162),
                                ...
                                {
                                    UserId = 2L,
                                    LastPasswordChangeAt = new DateTime(2024, 10, 5, 20, 20, 23, 277, DateTimeKind.Local).AddTicks(2208),
                                    PasswordHash = "22b46813685cbb9ce130ee451b78c820222740d47150a04a925778474898a90a",
                                    PasswordSalt = "d87fb28197dc4c88a790d5c31ff4d355",
                                    ReminderSent = false,
                                    Username = "mobile"
