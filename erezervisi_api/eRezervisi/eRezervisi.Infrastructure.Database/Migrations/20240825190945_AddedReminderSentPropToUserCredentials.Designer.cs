...
namespace eRezervisi.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240825190945_AddedReminderSentPropToUserCredentials")]
    partial class AddedReminderSentPropToUserCredentials
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("eRezervisi.Core.Domain.Entities.UserCredentials", "UserCredentials", b1 =>
                        {
                            ...
                            b1.HasData(
                                ...
                                {
                                    UserId = 1L,
                                    LastPasswordChangeAt = new DateTime(2024, 8, 25, 21, 9, 44, 567, DateTimeKind.Local).AddTicks(1784),
                                ...
                                {
                                    UserId = 2L,
                                    LastPasswordChangeAt = new DateTime(2024, 8, 25, 21, 9, 44, 567, DateTimeKind.Local).AddTicks(1847),
                                    PasswordHash = "e38fa1a920da144b4f91c910b3e8f432c1cd3a6dd27f40a8bad40317e25981cf",
                                    PasswordSalt = "a45e7aa02fd2414eb66c0c24562205ba",
                                    ReminderSent = false,
                                    Username = "mobile"
