...
namespace eRezervisi.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240822140611_RenamedReceiverField")]
    partial class RenamedReceiverField
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("eRezervisi.Core.Domain.Entities.UserCredentials", "UserCredentials", b1 =>
                        {
                            ...
                            b1.HasData(
                                ...
                                {
                                    UserId = 1L,
                                    LastPasswordChangeAt = new DateTime(2024, 8, 22, 14, 6, 10, 539, DateTimeKind.Utc).AddTicks(2274),
                                ...
                                {
                                    UserId = 2L,
                                    LastPasswordChangeAt = new DateTime(2024, 8, 22, 14, 6, 10, 539, DateTimeKind.Utc).AddTicks(2279),
                                    PasswordHash = "e38fa1a920da144b4f91c910b3e8f432c1cd3a6dd27f40a8bad40317e25981cf",
                                    PasswordSalt = "a45e7aa02fd2414eb66c0c24562205ba",
                                    Username = "mobile"
                                });
